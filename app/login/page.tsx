    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 flex items-center justify-center bg-kenzo-deep px-4 sm:px-8">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            <h1 className="text-2xl font-semibold text-kenzo-text">Sign in to Kenzo</h1>
            <p className="mt-1.5 text-sm text-kenzo-text-muted">Welcome back.</p>
          </div>
          ...
          <div className="flex gap-6 mb-8 border-b border-kenzo-border-subtle">
            ...
            <Link href="/signup" className="pb-2.5 text-sm font-medium text-kenzo-text-muted hover:text-kenzo-text-secondary transition-colors">
              Sign up
            </Link>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              ...
              <div className="mt-1.5 text-right">
                <Link href="#" className="text-xs text-kenzo-text-muted hover:text-kenzo-accent transition-colors">
                  Forgot password?
                </Link>
              </div>
            </div>
          ...
          <p className="mt-6 text-center text-xs text-kenzo-text-muted">
            ...
            <Link href="/signup" className="text-kenzo-text-secondary hover:text-kenzo-text transition-colors font-medium">
              Sign up
            </Link>
          </p>
